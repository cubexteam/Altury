...
public abstract class StringItemColorArmorBase extends ItemColorArmor implements StringItem {

    private final String namespaceId;

    public StringItemColorArmorBase(@NotNull String namespaceId, @Nullable String name) {
    ...
    @Override
    public StringItemColorArmorBase clone() {
        return (StringItemColorArmorBase) super.clone();
    }
}
