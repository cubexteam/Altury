...
public class BlockColor  {
    ...
    public static final BlockColor WHITE_TERRACOTTA_BLOCK_COLOR = new BlockColor(0xd1, 0xb1, 0xa1);
    public static final BlockColor ORANGE_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x9f, 0x52, 0x24);
    public static final BlockColor MAGENTA_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x95, 0x57, 0x6c);
    public static final BlockColor LIGHT_BLUE_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x70, 0x6c, 0x8a);
    public static final BlockColor YELLOW_TERRACOTTA_BLOCK_COLOR = new BlockColor(0xba, 0x85, 0x24);
    public static final BlockColor LIME_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x67, 0x75, 0x35);
    public static final BlockColor PINK_TERRACOTTA_BLOCK_COLOR = new BlockColor(0xa0, 0x4d, 0x4e);
    public static final BlockColor GRAY_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x39, 0x29, 0x23);
    public static final BlockColor LIGHT_GRAY_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x87, 0x6b, 0x62);
    public static final BlockColor CYAN_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x57, 0x5c, 0x5c);
    public static final BlockColor PURPLE_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x7a, 0x49, 0x58);
    public static final BlockColor BLUE_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x4c, 0x3e, 0x5c);
    public static final BlockColor BROWN_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x4c, 0x32, 0x23);
    public static final BlockColor GREEN_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x4c, 0x52, 0x2a);
    public static final BlockColor RED_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x8e, 0x3c, 0x2e);
    public static final BlockColor BLACK_TERRACOTTA_BLOCK_COLOR = new BlockColor(0x25, 0x16, 0x10);
